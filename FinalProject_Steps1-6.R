...
Saleslevels[findInterval(Saleslevels,c(10000,19999))==1L]<-1
Saleslevels[findInterval(Saleslevels,c(20000,29999))==1L]<-2
Saleslevels[findInterval(Saleslevels,c(30000,39999))==1L]<-3
Saleslevels[findInterval(Saleslevels,c(40000,49999))==1L]<-4
Saleslevels[findInterval(Saleslevels,c(50000,60000))==1L]<-5
...
levels(walmart$SL)<-list(L1=c(1),L2=c(2),L3=c(3),L4=c(4),L5=c(5))
